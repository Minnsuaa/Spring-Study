package com.example.springstudy.global.security.jwt;
...
import com.example.springstudy.global.exception.ExpiredJwtException;
import com.example.springstudy.global.exception.InvalidJwtException;
import com.example.springstudy.global.security.auth.AuthDetailsService;
...
public class JwtTokenProvider {
    ...
    public String parseToken(String bearerToken) {
        if (bearerToken != null && bearerToken.startsWith(jwtProperties.getHeader())) {
